...
function UI.CreateMinimapButton()
  ...
  texture:SetTexture("Interface\\Icons\\INV_Misc_Coin_02")
  texture:SetTexCoord(0.08, 0.92, 0.08, 0.92)
  texture:SetAllPoints(btn)

  local overlay = btn:CreateTexture(nil, "OVERLAY")
  overlay:SetTexture("Interface\\Minimap\\MiniMap-TrackingBorder")
  overlay:SetPoint("TOPLEFT", btn, "TOPLEFT", -5, 5)
  overlay:SetPoint("BOTTOMRIGHT", btn, "BOTTOMRIGHT", 5, -5)

  btn:SetScript("OnEnter", function()
    GameTooltip:SetOwner(this, "ANCHOR_LEFT")
    GameTooltip:SetText("|cff33ffccGuild|cffffffffKPInfo", 1, 1, 1)
    GameTooltip:AddLine("Click: Abrir / Cerrar", 0.6, 0.6, 0.6, 1)
    GameTooltip:Show()
  end)
